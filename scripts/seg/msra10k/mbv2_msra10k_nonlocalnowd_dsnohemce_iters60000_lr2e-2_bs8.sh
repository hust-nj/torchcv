...
CHECKPOINTS_NAME="mbv2_msra10k_nonlocalnowd_dsnohemce_iters60000_lr2e-2_bs8"$2
PRETRAINED_MODEL=$4
...
if [[ "$1"x == "train"x ]]; then
  ${DIST_PYTHON} main.py --config_file ${CONFIG_FILE} --phase train --train_batch_size 8 --val_batch_size 1 \
